...
const SingleCard = ({event}) => {
    return (
        <Body id={event.ename}>
            <br/>
            <br/>
            <Head href={event.ereg_link}>{event.ename}</Head>
            <br/>
            <SubHeadContentContainer>
              <SubHead>Registration Link: </SubHead>
              <ContentLink href={event.ereg_link}>Click here</ContentLink>
            </SubHeadContentContainer>
            <br/>
            <SubHeadContentContainer>
              <SubHead>Category: </SubHead>
              <Content>{event.ecategory}</Content>
            </SubHeadContentContainer>
            <SubHeadContentContainer>
              <SubHead>Date: </SubHead>
              <Content>{event.edate}</Content>
            </SubHeadContentContainer>
            <SubHeadContentContainer>
              <SubHead>Location: </SubHead>
              <Content>{event.elocation}</Content>
            </SubHeadContentContainer>
            <SubHeadContentContainer>
              <SubHead>Time: </SubHead>
              <Content>{event.etime}</Content>
            </SubHeadContentContainer>
            <SubHeadContentContainer>
              <SubHead>Eligibility: </SubHead>
              <Content>{event.eeligibility}</Content>
            </SubHeadContentContainer>
            <SubHeadContentContainer>
              <SubHead>Price: </SubHead>
              <Content>{event.eprice}</Content>
            </SubHeadContentContainer>
            <br/>
            <SubHead>Description: </SubHead>
            <Desc>{event.edescription}</Desc>
            <br/>
            <br/>
            <IDesc>READ THE INSTRUCTIONS CAREFULLY</IDesc>
            <br/>
            <ECard href={event.einstruction}>
